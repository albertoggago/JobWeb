...
@pytest.mark.timeout(TIME_OUT)
def test_recruitireland_error_no_exits():
...
@pytest.mark.timeout(TIME_OUT)
def test_recruitireland_error_retired():
...
@pytest.mark.timeout(TIME_OUT)
def test_webPageOther():
    """test_webPageOther"""
    urlOther = "http://www.youtube.com/somethig"
    correo_url = {"url":urlOther}    
    seleniumaccess = SeleniumAccess(CONFIG, "DEBUG")
    seleniumaccess.open_selenium()
    analyzer_web_jobs = AnalyzerWebJobs(CONFIG, "DEBUG")
    result = analyzer_web_jobs.analyze(correo_url,seleniumaccess.driver)
...
@pytest.mark.timeout(TIME_OUT)
def test_webPageError():
    """test_webPageError"""
    urlError = "http://www.any.com/somethig"
    correo_url = {"url":urlError}    
    seleniumaccess = SeleniumAccess(CONFIG, "DEBUG")
    seleniumaccess.open_selenium()
    analyzer_web_jobs = AnalyzerWebJobs(CONFIG, "DEBUG")
    result = analyzer_web_jobs.analyze(correo_url,seleniumaccess.driver)
